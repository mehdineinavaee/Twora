...
import irFlag from "../../assets/images/irf.png";

import classroomIcon from "../../assets/images/mag.png";
...
function Header(props) {
  ...
  const [showEducateItems, setShowEducateItems] = useState(false);

  const [selectedLang, setSelectedLang] = useState("fa");
  const [selectedLangIcon, setSelectedLangIcon] = useState("EN");

  const [hideLangButton, setHideLangButton] = useState(true);
  ...
  async function apiService() {
    const apiService = await http.get(config.apiService);
    setServiceData(apiService.data);
  }
  ...
  const changeLanguageByButtonClick = () => {
    ...
    console.warn(selectedLang);

    /* if (selectedLang)
        language = "en"; */

    /* if ( document.getElementById("language").value === "fa")
          //setSelectedLang("en");
          console.warn("i am en");
        else
          //setSelectedLang("fa");
          console.warn("i am fa"); */
  ...
  const googleTranslateElementInit = () => {
    new window.google.translate.TranslateElement(
      { pageLanguage: "fa", includedLanguages: "fa,en" },
  ...
  useEffect(() => {
    ...
    setLength(props.cartItems.length);
    ...
    if (document.getElementsByTagName("html")[0].lang === "fa")
      setSelectedLangIcon("FA");
    else setSelectedLangIcon("EN");
  ...
  React.useEffect(() => {
    setLength(props.cartItems.length);
    console.warn(props.cartItems.length);
                  ...
                  ? props.cartItems.map((cartItem) => {
                      return (
                        <li style={{ paddingBottom: "50px" }}>
                          ...
                          <div
                            className="sc-quantity"
                            style={{ marginRight: -20 }}
                          >
                            <span className="sc-price">
                              {cartItem
                                ? JSON.parse(
                                    cartItem.priceTakhfif
            ...
            <div className="sb-cartbox-footer">
              <div className="sb-cartbox-total">
                ...
                <span className="sb-cartbox-amount">
                  {/* {
                    console.warn(props.totalPrice)
                  } */}
                  {props.totalPrice >= 0
                    ? props.totalPrice.toLocaleString("fa-IR")
                    : false}{" "}
                  تومان
                </span>
              </div>
      ...
      <Drawer isOpen={menuDrawer} setIsOpen={setMenuDrawer}>
        <div className="">
          <ul className="menu-list d-xl-flex">
            ...
            <div
              onClick={() => setShowShopItems(!showShopItems)}
              className="drawer-link"
              style={{
                padding: "16px 20px 14px 20px",
                fontSize: "14px",
                    ...
                    >
                      <li>
                        <div
                          onClick={() => {
                            setMenuDrawer(false);
                            setShowShopItems(!showFormItems);
                          }}
                          className="drawer-link"
                          style={{
                            padding: "16px 20px 14px 20px",
            ...
            {/* <li> */}
            <div
              onClick={() => setShowEducateItems(!showEducateItems)}
              className="drawer-link"
              style={{
                padding: "16px 20px 14px 20px",
                fontSize: "14px",
            ...
            {showEducateItems
              ? ["مقالات", "ویدیو ها"].map((data, key) => {
                  return (
                    <NavLink to={`/blog_category/${key + 1}`}>
                      <li>
                        <div
                          onClick={() => {
                            setMenuDrawer(false);
                            setShowEducateItems(!showEducateItems);
                          }}
                          className="drawer-link"
                          style={{
                            padding: "16px 20px 14px 20px",
                        ...
                        >
                          <div style={{ marginRight: 20 }}>{data}</div>
                        </div>
                      </li>
                    </NavLink>
                  );
            ...
            <div
              onClick={() => setShowFormItems(!showFormItems)}
              className="drawer-link"
              style={{
                padding: "16px 20px 14px 20px",
                fontSize: "14px",
            ...
            {showFormItems
              ? ["ثبت سفارش", "درخواست همکاری", "مشاوره فنی"].map(
                  (data, key) => {
                    return (
                      <NavLink to={`/forms/${key + 1}`}>
                        <li>
                          <div
                            onClick={() => setMenuDrawer(false)}
                            className="drawer-link"
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    props.history.push(
                      ...
                      //`/product_category?category=${1}&page=1`
                    );
                  }
                }}
                value={search}
          ...
          <div className="ht-left">
            ...
            {name && (
              <span className="wel" style={{ fontSize: "14px" }}>
                {name} به سایت {`${process.env.REACT_APP_SITENAME}`} خوش آمدید
              </span>
            )}
          </div>
            ...
            <div className="ht-right_info">
              <ul className="ht-info-list">
                ...
                <li>
                  <div
                    translate="no"
                    className="hs-cartbox-inner d-inline"
                    align="center" /* onClick={changeLanguageByButtonClick } */
                  >
                ...
                <a href="#" onclick="doGTranslate('ru|ru');return false;" title="German" class="gflag nturl"
                  style="background-position:-500px -200px;"><img src="//gtranslate.net/flags/blank.png" height="16" width="16"
                    ...
                    {/* <NavLink to={`/#googtrans/fa/en`}> */}
                    {hideLangButton ? (
                      false
                    ) : (
                      <div
                        onClick={() => {
                          //setSelectedLangIcon(!selectedLangIcon);
                          //doGTranslate('ru|en');

                          //if (selectedLangIcon === "EN"){
                          var language = selectedLangIcon;
                          var selectField = document.querySelector(
                            "#google_translate_element select"
                          );

                          //console.warn(selectField.children);

                          for (
                            var i = 0;
                            i < selectField.children.length;
                            i++
                          ) {
                            var option = selectField.children[i];
                            //console.warn(selectField.children[i]);
                            //console.warn(option);
                            // find desired langauge and change the former language of the hidden selection-field
                            if (option.value == language.toLowerCase()) {
                              if (option.value === "en") {
                                selectField.selectedIndex = i;
                                // trigger change event afterwards to make google-lib translate this side
                                //console.warn(selectField.selectedIndex);
                                selectField.dispatchEvent(new Event("change"));
                                break;
                              } else {
                        ...
                        var selll = document.querySelector("#google_translate_element");

                        selll.value = "ru";

                        selll.dispatchEvent(new Event("change"));
                        
                        console.warn(selll);
                        } */

                          //console.warn(document.getElementsByTagName('html')[0].lang);

                          if (selectedLangIcon === "FA")
                            setSelectedLangIcon("EN");
                          else {
                            setHideLangButton(true);
                            setTimeout(() => {
                              setHideLangButton(false);
                            }, "4000");
                            setSelectedLangIcon("FA");
                          ...
                          //let selectField = document.querySelector("#google_translate_element");
                          //console.warn(selectField);
                          //document.documentElement.setAttribute("lang", 'fa');
                        }}
                        className="e-btn"
              ...
              {/* <input type="button" value="." id="language" 
                      onClick={changeLanguageByButtonClick} /> */}
            </div>
          </div>
        </div>
          ...
          <div className="hs-medium custom-scroll">
            <div className="nav-items main-menu-wraper">
              <ul className="menu-list d-xl-flex">
                ...
                <li>
                  <NavLink
                    to={`/product_category?category=${1}&page=1`}
                ...
                {/* <NavLink to="/blog_category/1">
                  <li className="menu-item">محتوای آموزشی</li>
                </NavLink> */}
                ...
                <li>
                  ...
                  <div className="drop-menu mega-menu">
                    <div
                      className="mega-menu-info d-lg-flex"
                    ...
                    >
                        ...
                        >
                          <div className="mega-menu-infobox text-center">
                            {/* <svg  width="70px" height="70px">
                              ...
                              /> *
                              <path 
                                fill="rgb(96, 186, 190)" d="M57,31.537c0-1.5,0-5.8,0-5.8c0-0.5-0.3-0.9-0.7-1l-5.3-1.5l8.5-4.3c0.4-0.2,0.6-0.5,0.6-0.9s-0.3-0.7-0.6-0.9l-29-14.5
                                ...
                                c0.6,0,1,0.4,1,1V46.537z"/>
		                          <rect
                                fill="rgb(96, 186, 190)" x="38" y="49.537" width="5" height="2"/>
                              
                            </svg> */}

                            <img src={classroomIcon} style={{ width: "8%" }} />

                            <h5 className="e-mm-ib-ttl">مجلات آموزشی</h5>
                          </div>
                        </NavLink>
                      </div>
                      <div className="col-lg-4">
                        ...
                        >
                          <div className="mega-menu-infobox text-center">
                            ...
                            <img src={videoIcon} style={{ width: "8%" }} />
                            <h5 className="e-mm-ib-ttl">ویدیوهای آموزشی</h5>
                            {/* <p>مشاوره و تماس رایگان ۷-۲۴</p> */}
                          </div>
                        </NavLink>
                      </div>
                      ...
                      <NavLink
                        ...
                        <div className="mega-menu-infobox text-center">
                          ...
                          <h5 className="e-mm-ib-ttl">مشاوره فنی</h5>
                ...
                <NavLink
                  ...
                  to="/news_category/1"
                >
                  <li className="menu-item">اخبار</li>
                </NavLink>
                ...
                <NavLink
                  ...
                  to="/gallery"
                >
                  <li className="menu-item">گالری</li>
                </NavLink>

                {/* <NavLink to="/blog_category/2">
                  <li className="menu-item">فرم ها</li>
                </NavLink> */}

                <li>
                  <NavLink to="/forms/1" style={{ marginLeft: "3em" }}>
                    فرم ها
                  </NavLink>
                  <div className="drop-menu mega-menu">
                    <div className="mega-menu-info d-lg-flex">
                      <div className="col-lg-4">
                        ...
                        >
                          <div className="mega-menu-infobox text-center">
                            ...
                            <h5 className="e-mm-ib-ttl">ثبت سفارش</h5>
                          </div>
                        </NavLink>
                      </div>
                      <div className="col-lg-4">
                        ...
                        >
                          <div className="mega-menu-infobox text-center">
                            ...
                            <h5 className="e-mm-ib-ttl">درخواست همکاری</h5>
                            {/* <p>مشاوره و تماس رایگان ۷-۲۴</p> */}
                          </div>
                        </NavLink>
                      </div>
                ...
                <NavLink to="/branch_map">
                  <li className="menu-item" style={{ width: 170 }}>
                    نمایش نمایندگان روی نقشه
                  </li>
                </NavLink>
              </ul>
